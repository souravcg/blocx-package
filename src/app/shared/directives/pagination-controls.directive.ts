...
import {PaginationInstance} from '../../core/services/pagination-instance';
...
export class PaginationControlsDirective {
    ...
    @Output() blocxPageChange: EventEmitter<number> = new EventEmitter<number>();
    pages: Page[] = [];
    ...
    setCurrent(page: number) {
        this.blocxPageChange.emit(page);
    }
